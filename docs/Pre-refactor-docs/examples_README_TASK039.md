...
- SPH neighbour finding and hydro forces
...
2. **Run Full SPH Evolution:**
   ...
   - Enable neighbour finding and hydro forces
...
3. **No SPH evolution:** Hydro forces, neighbour finding, and density updates are not included. These are conceptual demos of the framework workflow.
