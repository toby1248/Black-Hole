...
### Further Considerations
   ...
   - Clarify in per-submodule `CLAUDE.md` that Phase 2 will introduce CUDA to implement where feasible and support where possible; this affects how `sph` and `gravity` agents structure new code.
